...
endpointInterface = "com.mobile263.iotbss.webservice.IStopReplyThe")//接口地址
@Component
public class StopReplyTheImpl implements IStopReplyThe {

	@Override
	public RspMessageBody StopReplyThe(ReqMessageBody request) {
